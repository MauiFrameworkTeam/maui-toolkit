...
namespace Syncfusion.Maui.Toolkit.UnitTest
{
    public class DataLabelUnitTests : BaseUnitTest
    {
        ...
        public void CalculateDataLabelPoint_NullLabelTemplate_ReturnsCalculatedPosition()
        {
            var sfCartesianChart = new SfCartesianChart();
            ...
            var expectedResult = new PointF(50, 50);
            PointF result = cartesianDataLabelSettings.CalculateDataLabelPoint(columnSeries, columnSegment, labelPoint, chartDataLabelStyle);
            Assert.Equal(expectedResult, result); 
        }
