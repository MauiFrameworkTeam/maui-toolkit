...
namespace Syncfusion.Maui.Toolkit.UnitTest
{
    public class AnnotationUnitTest : BaseUnitTest
    {
        ...
        public void TransformCoordinates_Test()
        {
            ...
            chart.ChartArea.ActualSeriesClipRect = new Rect(70, 20, 875, 234);
        ...
        public void ApplyAlignment_Test(ChartAlignment verticalAlignment, ChartAlignment horizontalAlignment, double x, double y, double width, double height, double expectedX, double expectedY)
        {
            ...
            InvokePrivateMethod(annotation, "ApplyAlignment", new object[] { x, y, width, height });
        ...
        public void HorizontalLineAnnotationResetPosition_Test()
        {
            ...
            annotation.LineCapPoints = new List<Point>() { new Point(1, 1) };
        ...
        public void CalculateArrowPoints_ShouldReturnCorrectPoints(float x1, float y1, float x2, float y2, float strokeWidth)
        {
            ...
            var result = InvokePrivateMethod(annotation, "CalculateArrowPoints", new object[] { x1, y1, x2, y2 }) as List<Point>;
        ...
        [Fact(Skip = "Test is currently not runnable due to measure was not consider.")]
        public void SetTextAlignment_Test()
        {
            var annotation = new EllipseAnnotation
            {
                RenderRect = new Rect(322.60000610351562, 135.40000915527344, 20, 10),
                annotationLabelStyle = new ChartAnnotationLabelStyle
                {
            ...
            annotation.SetTextAlignment(332.60000610351562, 140.40000915527344);

            Assert.Equal(new Rect(332.60000610351562, 140.40000915527344, 147, 34), annotation.LabelRect);
        }
