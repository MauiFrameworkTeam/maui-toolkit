...
namespace Syncfusion.Maui.Toolkit.UnitTest
{
    public class SegmentUnitTests:BaseUnitTest
    {
        ...
        public void GetMarkerRect_WithValidTooltipIndex_ShouldReturnCorrectRect()
        {
            ...
            var markerHeight = 15;
            int tooltipIndex = 1;
            areaSegment.FillPoints = new List<float> { 0, 0, 30, 40, 60, 80 };
            areaSegment.XValues = new double[] { 1, 2, 3 }; 
                        ...
                        float expectedXPosition, float expectedYPosition)
        {
            ...
            var dataLabelPosition = (PointF?)InvokePrivateMethod(areaSegment, "GetDataLabelPosition",new object[] { xValue, yValue, areaSeries });
        ...
        public void Layout_ShouldSetLayoutValuesCorrectly()
        {
            ...
            InvokePrivateMethod(boxAndWhiskerSegment, "Layout", new object[] { boxAndWhiskerSeries });
        ...
        {
            var bubbleSegment = new BubbleSegment();
            bubbleSegment.CenterX = 10;
            bubbleSegment.CenterY = 10;
            bubbleSegment.Radius = 5;
            bubbleSegment.StrokeWidth = 1;
            bubbleSegment.Series = new BubbleSeries();
            bubbleSegment.Series.Segments.Add(bubbleSegment);
        ...
        {
            var candleSegment = new CandleSegment();
            candleSegment.SegmentBounds = new RectF(0, 0, 10, 10);
            var candleSeries = new CandleSeries();
            candleSeries.Segments.Add(candleSegment);
            candleSegment.Series = candleSeries;
        ...
        public void Layout_ShouldSetLeftToNaN_WhenOutsideAxisRange()
        {
            var candleSegment = new CandleSegment();
            var candleSeries = new CandleSeries();
            candleSeries.ActualXAxis = new NumericalAxis
            {
            ...
            InvokePrivateMethod(candleSegment, "Layout", new object[] { candleSeries });
        ...
        public void GetDynamicAnimationValue_ShouldReturnExpectedResult(float animationValue, float expected, float oldValue, float newValue)
        {
            ...
            float result = columnSegment.GetDynamicAnimationValue(animationValue, 0, oldValue, newValue);
        ...
        { 
            var columnSegment = new ColumnSegment();
            columnSegment.Series = new ColumnSeries();
            columnSegment.SegmentBounds = new Rect(0, 0, 10, 10);
            columnSegment.Series.Segments.Add(columnSegment); 
        ...
        { 
            ...
            var doughnutSeries = new DoughnutSeries { isClockWise = true };
        ...
        { 
            var doughnutSegment = new DoughnutSegment();
            var doughnutSeries = new DoughnutSeries { isClockWise = false };
            doughnutSegment.Series = doughnutSeries; 
            double mStartAngle = 30.0;
            double mEndAngle = 60.0;
            double mYValue = 100.0; 
        ...
        { 
            var doughnutSegment = new DoughnutSegment();
            doughnutSegment.Series = new DoughnutSeries(); 
        ...
        { 
            ...
            var result=(bool?)InvokePrivateMethod(doughnutSegment, "IsPointInDoughnutSegment", new object[] { 40, 50, 50 });
            Assert.True(result);
        }
        ...
        public void IsPointInDoughnutSegment_WithInvalidPoint_ShouldReturnFalse()
        {
            ...
            SetPrivateField(doughnutSegment, "_currentBounds", new RectF(0, 0, 100, 100));
            doughnutSegment.InnerRadius = 20; 
            var result=(bool?)InvokePrivateMethod(doughnutSegment, "IsPointInDoughnutSegment", new object[] { 10, 10, 50 }); 
            Assert.False(result);
        }
        [Fact]
        ...
        { 
            ...
            var result = (double[]?)InvokePrivateMethod(errorBarSegment, "GetSdErrorValue", new object[] { values }); 
        ...
        { 
            ...
            var errorBarSeries = new ErrorBarSeries
            {
                ...
                HorizontalErrorValues = new List<double> { 0.5, 0.3, 0.2, 0.4, 0.6 },
                VerticalErrorValues = new List<double> { 0.5, 0.4, 0.3, 0.5, 0.6 }
            };
            errorBarSegment.Series = errorBarSeries; 
        ...
        { 
            var sfCartesianChart = new SfCartesianChart();
            CartesianChartArea chartArea = new CartesianChartArea(sfCartesianChart);
            ...
            var fastLineSegment = new FastLineSegment
            {
                ...
                YValues = new List<double> { 10, 20, 15, 30, 25 },
        ...
        {  
            ...
            List<double> yValues = new List<double> { 10, 20, 15, 30, 25 }; 
        ...
        { 
            ...
            List<double> xValues = new List<double> { 1, double.NaN, 3, 4, 5 };
            List<double> yValues = new List<double> { 10, 20, double.NaN, 30, 25 }; 
            fastLineSegment.SetData(xValues, yValues); 
        ...
        { 
            ...
            InvokePrivateMethod(fastLineSegment, "UpdateLinePoints",new object[] { linePoints, preXPos, preYPos, x, y }); 
        ...
        { 
            ...
            float leftOffset = 10;
            float topOffset = 10; 
            var result=(float?)InvokePrivateMethod(fastLineSegment, "ValueToPoint", new object[] { value, start, delta, isInversed, isVertical, width, height, leftOffset, topOffset });
        ...
        public void OnDataLabelLayout_ShouldUpdateLabelPositionPoints()
        { 
            var fastLineSegment = new FastLineSegment();
            var fastLineSeries = new FastLineSeries
            {
                ...
                ActualData = new List<object> { new object(), new object(), new object() }
            };
            var xValues = new List<double> { 1, 2, 3 };
            var yValues= new List<double> { 10, 20, 15 };
            fastLineSegment.XValues = xValues;
            fastLineSegment.YValues = yValues;
            fastLineSegment.Series = fastLineSeries;
            fastLineSegment.DataLabels = new List<ChartDataLabel> { new ChartDataLabel(), new ChartDataLabel(), new ChartDataLabel() };
            fastLineSegment.OnDataLabelLayout();
            Assert.NotNull(fastLineSeries.DataLabels);
            Assert.Equal(3, fastLineSeries.DataLabels.Count);
