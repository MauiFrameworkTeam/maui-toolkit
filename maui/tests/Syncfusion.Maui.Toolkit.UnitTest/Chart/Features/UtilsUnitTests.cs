...
namespace Syncfusion.Maui.Toolkit.UnitTest 
{
    public class UtilsUnitTests:BaseUnitTest
    {
        ...
        [Theory(Skip ="need to check later")]
        [InlineData("2023-01-15", 1, "2023-02-15")]
        [InlineData("2023-02-15", 1, "2023-03-15")]
        [InlineData("2023-02-15", 0.5, "2023-03-02")]
        [InlineData("2023-12-15", 1, "2024-01-15")]
        [InlineData("2020-02-15", 1, "2020-03-14")]  
        [InlineData("2021-02-15", 1, "2021-03-16")] 
        public void AddMonth_ShouldReturnExpectedDate(string startDate, double interval, string expectedDate)
        { 
            DateTime date = DateTime.Parse(startDate);
            DateTime expected = DateTime.Parse(expectedDate); 
            DateTime result = ChartDataUtils.AddMonth(date, interval); 
            Assert.Equal(expected, result);
        }
        ...
        { 
            var chartMarkerSettings = new ChartMarkerSettings();
        ...
        { 
            ...
            var result = (int?)InvokeStaticPrivateMethodClass(typeof(ChartUtils), "GetPointDirection", new object[] { point1, point2, point3 });
            Assert.Equal(expected, result);
        }
