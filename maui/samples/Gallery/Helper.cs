...
namespace Syncfusion.Maui.ControlsGallery
{
    ...
    public class PositionHelper
    {
        ...
        /// 
        /// </summary>
        public static List<ControlTile> ControlTiles = new();
    ...
    public static class BaseConfig
    {
        ...
        /// 
        /// </summary>
        public static Dictionary<string, Stream> AvailableControlStreamList = new();
                ...
                foreach (var assembly in AllProducts)
                {
                    ...
                    foreach (var item in products)
                    {
                        ...
                        if (type != null)
                        {
                            ...
                            var controlStream = ControlListPath.GetManifestResourceStream(commonNameSpace + "." + name + "SamplesList.xml");
